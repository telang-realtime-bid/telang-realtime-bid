            ...
            <div className="card border lg:card-side mt-4 shadow-xl">
              ...
              <div className="card-body bg-base-200">
                ...
                <div className="flex mt-1">
                  <input
                    onChange={(e) => setNewInputBid(e.target.value)}
                    value={newInputBid}
                    onKeyPress={(e) => e.key === 'Enter' && sendBid()}
                    type="number"
                    placeholder="Input your bid..."
                    className="input input-bordered w-full"
                  />
                  <button onClick={sendBid} className='btn bg-base-300 mb-3 ml-2 w-20 text-center'>Bid</button>
                </div>
              </div>
            </div>
          </div>
