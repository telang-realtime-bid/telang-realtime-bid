...
import imageForm from '../assets/register.jpg'
          ...
          <div className="relative flex flex-col bg-base-200 shadow-2xl rounded-2xl md:flex-row md:space-y-0">
            <div className="flex flex-col justify-center p-8 md:p-14">
              ...
              <span className="font-light text-bg-body-secondary">
                Welcome to Telang, your place to auction!
              </span>
              {isError && (
              ...
              <div className="py-1">
                ...
                <input
                  type="text"
                  className="w-full p-2 rounded-md border border-base-300"
                  name="fullname"
                  id="fullname"
            ...
            <div className="relative bg-base-300 rounded-md">
              <img
                src={imageForm}
                alt="img"
                className="w-[450px] h-[550px] hidden rounded-r-2xl md:block object-cover"
              />
            </div>
          </div>
        </form>
